-- OP1: register mv_indigenous_proven_suppliers in the nightly cron's refresh_order array.
-- Re-dumped via pg_get_functiondef with one array line inserted after mv_justice_proven_suppliers.
