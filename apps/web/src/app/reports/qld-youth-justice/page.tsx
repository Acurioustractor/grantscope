...
async function getQldReport() {
  const [
    ...
    getAlmaInterventions('youth-justice', 25, 'QLD'),
    getAlmaCount('youth-justice', 'QLD'),
    getFundingByLga('youth-justice', 20, 'QLD'),
    getAccoFundingGap('youth-justice', 'QLD'),
    getFundingByRemoteness('youth-justice', 'QLD'),
    getEvidenceCoverage('youth-justice', 'QLD'),
    getEvidenceGapDetail('youth-justice', 'QLD'),
    getQldHansardMentions(20),
...
export default async function QldYouthJusticePage() {
  const report = await getQldReport();
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-bauhaus-muted text-base sm:text-lg max-w-3xl leading-relaxed font-medium">
          Queensland accounts for the majority of Australia&apos;s youth justice funding data.
          This report maps who gets funded, what evidence exists, where the gaps are,
          and who has political connections.
        </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
        <div className="bg-red-50 border border-red-200 rounded-xl p-5 text-center">
          ...
          <div className="text-xs text-gray-500 mt-1">QLD Youth Justice Funding</div>
        </div>
      ...
      {report.revolvingDoor.length > 0 && (
        <section className="mb-12">
          ...
          <p className="text-sm text-bauhaus-muted mb-4">QLD youth justice organisations with multiple influence vectors (donations, contracts, lobbying, funding).</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-bauhaus-black">
      ...
      <section className="mb-12">
        ...
        {report.hansard.length === 0 && report.lobbying.length === 0 && (
          <p className="text-sm text-gray-500 italic">No political connection data available for QLD youth justice organisations.</p>
        )}
      </section>
