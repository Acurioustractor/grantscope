...
const getCachedDashboardApiData = unstable_cache(async () => {
...
}, ['dashboard-api-data-v1'], { revalidate: 900 });
...
export async function GET() {
  ...
  try {
    const response = NextResponse.json(await getCachedDashboardApiData());
