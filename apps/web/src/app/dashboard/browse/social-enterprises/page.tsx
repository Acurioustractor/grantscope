...
/**
 * The index moved to its public URL, /social-enterprises, and kept the Shell layout with it.
 *
 * It lived here and at /social-enterprises simultaneously — two indexes over identical data, one a thin
 ...
 */
export default function MovedBrowseSocialEnterprises() {
  redirect('/social-enterprises');
}
