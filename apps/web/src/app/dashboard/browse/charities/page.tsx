...
/**
 * The index moved to its public URL, /charities, and kept the Shell layout with it.
 *
 * It lived here and at /charities simultaneously — two indexes over identical data, one a thin
 ...
 */
export default function MovedBrowseCharities() {
  redirect('/charities');
}
