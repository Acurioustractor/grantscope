...
/**
 * The index moved to its public URL, /grants, and kept the Shell layout with it.
 *
 * It lived here and at /grants simultaneously — two indexes over identical data, one a thin
 ...
 */
export default function MovedBrowseGrants() {
  redirect('/grants');
}
