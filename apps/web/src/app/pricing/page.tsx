    ...
    <div>
      <div className="mb-10">
        ...
        <p className="text-xl text-bauhaus-muted leading-tight font-medium max-w-3xl mb-4">
          We&apos;re not guessing at prices. CivicGraph is being built in public — pricing follows the conversation. Tick what fits, tell us how you&apos;d actually use it, and we&apos;ll come back with something shaped to how you work.
        </p>
