...
export function KanbanCard({ grant, index }: { grant: SavedGrantRow; index: number }) {
        ...
        >
          <div className="flex items-start justify-between gap-2">
            <a
              ...
              className="text-sm font-bold text-bauhaus-black hover:text-bauhaus-blue leading-tight line-clamp-2"
