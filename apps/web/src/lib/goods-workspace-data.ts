...
type NtCommunityProcurementSummaryRow = {
  community_id: string;
...
type NtCommunityBuyerCrosswalkRow = {
  community_name: string;
  buyer_name: string;
  buyer_type: string;
  gs_id: string | null;
...
type GoodsTrackedIdentitySource =
  | 'org_profile_abn'
  | 'org_profile_name'
  | 'env_abn'
  | 'env_name';

type GoodsIdentityCandidate = {
  name: string | null;
  abn: string | null;
