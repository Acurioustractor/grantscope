...
const BUYER_SEEDS: GoodsBuyerSeed[] = [
  ...
  },
  {
    ...
    role: 'Remote community buyer / largest single demand signal',
    states: ['NT'],
    route: 'Direct community procurement',
    relationshipStatus: 'prospect',
    contactSurface: 'Simone Grimmond — documented request through community channels',
    knownOrderSignal: 'Documented request for 500 mattresses + 300 washing machines (~$1.7M).',
    remoteFootprint: 'Island community — everything comes by barge, freight premium is extreme.',
    productFit: 'Beds, washers, health hardware — entire Goods product line at scale.',
    procurementPath: 'Combine with Groote Eylandt Aboriginal Trust for place-based production and supply ask.',
    nextAction: 'This is the single largest demand signal. Pair with Groote Trust capital and Miwatj health delivery.',
  },
  {
    key: 'picc',
    matchPattern: 'PALM ISLAND COMMUNITY',
    name: 'Palm Island Community Company (PICC)',
    role: 'Community buyer and potential facility host',
    states: ['QLD'],
    route: 'Direct community procurement + production hosting',
    relationshipStatus: 'active',
    contactSurface: 'Narelle — existing relationship, 141 beds deployed',
    knownOrderSignal: '141 beds deployed. 40-bed order discussed. Said "we\'ll buy the production facility itself."',
    remoteFootprint: 'Largest single community deployment. Island logistics via barge.',
    productFit: 'Beds for community. Potential production facility host for QLD.',
    procurementPath: 'Convert existing deployment success into repeat bulk orders plus facility hosting.',
    nextAction: 'Lock the 40-bed follow-on order and scope production facility hosting on Palm Island.',
  },
  {
    key: 'homeland-schools',
    matchPattern: 'HOMELAND SCHOOL',
    name: 'Homeland Schools Company',
    role: 'Education sector buyer',
    states: ['NT'],
    route: 'Education procurement',
    relationshipStatus: 'warm',
    contactSurface: 'Existing relationship — $34K invoice outstanding (INV-0303)',
    knownOrderSignal: '24 beds deployed Maningrida. 65 beds requested for kids.',
    remoteFootprint: 'Maningrida homelands and school network.',
    productFit: 'Beds for children in remote school/homeland settings.',
    procurementPath: 'Chase outstanding invoice; convert into standing education procurement pathway.',
    nextAction: 'Collect on INV-0303 ($34K). Package 65-bed order as children\'s health and education case.',
  },
];
...
const CAPITAL_SEEDS: GoodsCapitalSeed[] = [
  ...
  {
    key: 'tim-fairfax',
    foundationPattern: 'TIM FAIRFAX',
    name: 'Tim Fairfax Family Foundation',
    instrumentType: 'grant',
    relationshipStatus: 'warm',
    stageFit: ['working capital', 'facility'],
    contactSurface: 'Katie Norman — 33 communications logged. QLD focus.',
    knownSignal: 'Strong QLD philanthropy interest. Sally recommended. Palm Island is strongest QLD proof.',
    nextAction: 'Lead with Palm Island proof and QLD production expansion story.',
  },
  {
    key: 'pfi',
    grantPattern: 'PFI',
    ...
    relationshipStatus: 'warm',
    stageFit: ['working capital', 'facility', 'scale'],
    contactSurface: 'PFIFund@treasury.qld.gov.au — EOI due Mar 15, 2026.',
    knownSignal: '$640,000 repayable instrument. QLD Treasury. Would be largest single capital injection.',
    nextAction: 'Confirm EOI submission status. Prepare full application if invited.',
  },
  {
    key: 'dusseldorp',
    foundationPattern: 'DUSSELDORP',
    name: 'Dusseldorp Forum',
    instrumentType: 'grant',
    relationshipStatus: 'warm',
    stageFit: ['facility', 'scale'],
    contactSurface: 'Meeting held Oct 2025. Justice reinvestment angle.',
    knownSignal: 'Active relationship. Justice reinvestment and community-led solutions focus.',
    nextAction: 'Follow up with updated impact data and production facility progress.',
  },
  {
    key: 'giant-leap',
    foundationPattern: 'GIANT LEAP',
    name: 'Giant Leap (Impact VC)',
    instrumentType: 'co-investment',
    relationshipStatus: 'prospect',
    stageFit: ['scale'],
    contactSurface: 'Sally Grimsley-Ballard recommended. Impact VC pathway.',
    knownSignal: 'Impact VC interest validates investable social enterprise thesis.',
    nextAction: 'Approach when ready for equity conversation. Snow validation + SEFA debt = VC readiness signal.',
  },
];
...
const PARTNER_SEEDS: GoodsPartnerSeed[] = [
  ...
  },
  {
    ...
    matchPattern: 'PALM ISLAND COMMUNITY',
    name: 'Palm Island Community Company (PICC)',
    role: 'Community partner and potential production facility host',
    states: ['QLD'],
    relationshipStatus: 'active',
    knownSignal: '141 beds deployed — largest single deployment. Said "we\'ll buy the production facility itself."',
    nextAction: 'Explore production facility hosting on Palm Island. Strongest QLD community relationship.',
  },
  {
    key: 'wilya-janta',
    matchPattern: 'WILYA JANTA',
    name: 'Wilya Janta',
    role: 'Housing advocacy and demonstration home partner',
    states: ['NT'],
    relationshipStatus: 'active',
    knownSignal: 'Founded by Norman Frank Jupurrurla and Dr Simon Quilty. Active bed testing. Tennant Creek anchor.',
    nextAction: 'Tennant Creek demonstration home partnership. Norman Frank is powerful community voice for grants.',
  },
  {
    key: 'defy-design',
    matchPattern: 'DEFY DESIGN',
    name: 'Defy Design',
    role: 'Manufacturing knowledge transfer and training partner',
    states: ['NSW'],
    relationshipStatus: 'active',
    knownSignal: 'Key manufacturing partner. Training Ebony + Jahvan Oui for on-country production. Knowledge transfer for containerised plant.',
    nextAction: 'Continue skills transfer. Use as manufacturing credibility proof in grant applications.',
  },
  {
    key: 'envirobank',
    matchPattern: 'ENVIROBANK',
    name: 'Envirobank',
    role: 'Recycled HDPE supply chain partner',
    states: ['QLD', 'NT'],
    relationshipStatus: 'warm',
    knownSignal: 'Meeting held Feb 11, 2026. Indigenous-led supply chain alignment. Marty Taylor + Narelle Anderson.',
    nextAction: 'Formalise recycled HDPE supply partnership. Strengthens circular economy narrative for every grant.',
  },
  {
    key: 'npy',
    matchPattern: 'NPY WOMEN',
    name: "NPY Women's Council",
    role: 'Cross-border community distribution partner',
    states: ['NT', 'SA', 'WA'],
    relationshipStatus: 'active',
    knownSignal: '"Always looking for beds." Angela Lynch. Established network across Ngaanyatjarra, Pitjantjatjara, Yankunytjatjara lands.',
    nextAction: 'Ongoing demand across 3 jurisdictions. Use as proof of cross-border reach in national grants.',
  },
];
...
function buildCapitalPathways(capitalTargets: GoodsCapitalTarget[]) {
  ...
  return [
    ...
    },
    {
      ...
      summary: 'Combine Groote Aboriginal Trust capital + WHSAC demand (500 beds, 300 washers) + Miwatj health delivery into the largest single place-based production opportunity.',
      targetIds: ['groote', 'miwatj'].filter((id) => byId.has(id)),
    },
    {
      id: 'qld-expansion',
      title: 'QLD expansion via PFI + Tim Fairfax + PICC',
      summary: 'Stack PFI repayable capital ($640K) with Tim Fairfax philanthropy and PICC production hosting to establish QLD as second manufacturing base after NT.',
      targetIds: ['pfi', 'tim-fairfax'].filter((id) => byId.has(id)),
    },
