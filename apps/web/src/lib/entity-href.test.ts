...
describe('entityHref', () => {
  it('links to the public entity page by gs_id', () => {
    expect(entityHref({ gsId: 'AU-ORIC-8123', abn: '12345678901', name: 'X' })).toBe('/entities/AU-ORIC-8123');
  });

  it('falls back to the ABN form when there is no gs_id', () => {
    expect(entityHref({ abn: '12 345 678 901', name: 'X' })).toBe('/entities/AU-ABN-12345678901');
  });
