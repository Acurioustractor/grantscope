...
export const AGENTS: Record<string, AgentDef> = {
  ...
  'scout-grants-for-profiles':    { command: ['npx', 'tsx', 'scripts/scout-grants-for-profiles.mjs'], displayName: 'Grant Scout', category: 'intelligence', defaultPriority: 2, timeoutMs: 300_000, dependencies: [] },
  'classify-grants-classie':      { command: ['npx', 'tsx', 'scripts/classify-grants-classie.mjs', '--limit=1000'], displayName: 'Classify Grants (CLASSIE)', category: 'intelligence', defaultPriority: 3, timeoutMs: 300_000, dependencies: [] },
