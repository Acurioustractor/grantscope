...
3. **One lighthouse buyer.** A Vic or SA government buyer with SPF/SAIPP obligations using a tender-pack in a real procurement. Worth more than the next 5,000 rows. Machinery: `scripts/scout-se-buyers.mjs` ranks every government buyer by their existing SE contract evidence — warm prospects are buyers who ALREADY buy from SEs and can be shown their own social-procurement story. Workflow: `/lighthouse` skill.
