...
**Branch:** working on `feat/person-identities-migration` (LOCAL-ONLY commits `961f1be` scaffolding + `82149be` MV draft, NOT pushed); `main` at `9942c11`. **Open PR: #92** (read-only gate). person_identities table is LIVE in prod (additive, unread). CI green.
