...
const GRANT_SOURCE_TARGETS = [
  ...
  {
    sourceKey: 'grant-source:creative-australia:opportunities',
    sourceKind: 'grant_source_page',
    sourceName: 'Creative Australia Investments and Opportunities',
    targetUrl: 'https://creative.gov.au/investments-opportunities',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'creative-australia',
    cadenceHours: 12,
    priority: 9,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'arts'], capital_types: ['grant', 'fellowship', 'prize'], portfolio_lanes: ['arts-cultural'] },
  },
  {
    sourceKey: 'grant-source:regional-arts-fund',
    sourceKind: 'grant_source_page',
    sourceName: 'Regional Arts Fund',
    targetUrl: 'https://regionalarts.com.au/regional-arts-fund/',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'regional-arts-fund',
    cadenceHours: 24,
    priority: 9,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'regional-arts'], capital_types: ['grant'], portfolio_lanes: ['arts-cultural', 'regional-remote'] },
  },
  {
    sourceKey: 'grant-source:screen-australia:funding',
    sourceKind: 'grant_source_page',
    sourceName: 'Screen Australia Funding and Support',
    targetUrl: 'https://www.screenaustralia.gov.au/funding-overview/',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'screen-australia',
    cadenceHours: 24,
    priority: 8,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'screen'], capital_types: ['grant', 'development-investment'], portfolio_lanes: ['arts-cultural', 'storytelling'] },
  },
  {
    sourceKey: 'grant-source:office-for-the-arts',
    sourceKind: 'grant_source_page',
    sourceName: 'Office for the Arts Funding and Support',
    targetUrl: 'https://www.arts.gov.au/funding-and-support',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'office-for-the-arts',
    cadenceHours: 24,
    priority: 8,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'arts-policy'], capital_types: ['grant', 'program'], portfolio_lanes: ['arts-cultural', 'first-nations'] },
  },
  {
    sourceKey: 'grant-source:arts-queensland',
    sourceKind: 'grant_source_page',
    sourceName: 'Arts Queensland Funding',
    targetUrl: 'https://www.arts.qld.gov.au/aq-funding',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'arts-queensland',
    cadenceHours: 24,
    priority: 8,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'state-arts'], capital_types: ['grant'], portfolio_lanes: ['arts-cultural', 'queensland'] },
  },
  {
    sourceKey: 'grant-source:create-sa',
    sourceKind: 'grant_source_page',
    sourceName: 'CreateSA Funding',
    targetUrl: 'https://www.create.sa.gov.au/',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'create-sa',
    cadenceHours: 24,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'state-arts'], capital_types: ['grant'], portfolio_lanes: ['arts-cultural', 'south-australia'] },
  },
  {
    sourceKey: 'grant-source:arts-tasmania',
    sourceKind: 'grant_source_page',
    sourceName: 'Arts Tasmania Grants and Loans',
    targetUrl: 'https://www.arts.tas.gov.au/grants_and_loans',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'arts-tasmania',
    cadenceHours: 24,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'state-arts'], capital_types: ['grant', 'loan'], portfolio_lanes: ['arts-cultural', 'tasmania'] },
  },
  {
    sourceKey: 'grant-source:wa-creative-industries',
    sourceKind: 'grant_source_page',
    sourceName: 'WA Creative Industries Funding',
    targetUrl: 'https://www.dlgsc.wa.gov.au/funding/creative-industries-funding',
    parserHint: 'arts-funding-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'wa-creative-industries',
    cadenceHours: 24,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'state-arts'], capital_types: ['grant'], portfolio_lanes: ['arts-cultural', 'western-australia'] },
  },
  {
    sourceKey: 'opportunity-source:austender',
    sourceKind: 'grant_source_page',
    sourceName: 'AusTender Current Opportunities',
    targetUrl: 'https://www.tenders.gov.au/',
    parserHint: 'procurement-opportunity-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'austender-opportunities',
    cadenceHours: 6,
    priority: 9,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'procurement'], capital_types: ['procurement'], portfolio_lanes: ['commercial-public-benefit', 'goods'] },
  },
  {
    sourceKey: 'opportunity-source:buy-nsw',
    sourceKind: 'grant_source_page',
    sourceName: 'Buy NSW Opportunities',
    targetUrl: 'https://buy.nsw.gov.au/',
    parserHint: 'procurement-opportunity-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'buy-nsw-opportunities',
    cadenceHours: 12,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'procurement'], capital_types: ['procurement'], portfolio_lanes: ['commercial-public-benefit'] },
  },
  {
    sourceKey: 'opportunity-source:tenders-sa',
    sourceKind: 'grant_source_page',
    sourceName: 'Tenders SA',
    targetUrl: 'https://www.tenders.sa.gov.au/',
    parserHint: 'procurement-opportunity-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'tenders-sa-opportunities',
    cadenceHours: 12,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'procurement'], capital_types: ['procurement'], portfolio_lanes: ['commercial-public-benefit'] },
  ...
  {
    sourceKey: 'opportunity-source:tenders-wa',
    sourceKind: 'grant_source_page',
    sourceName: 'Tenders WA',
    targetUrl: 'https://www.tenders.wa.gov.au/',
    parserHint: 'procurement-opportunity-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'tenders-wa-opportunities',
    cadenceHours: 12,
    priority: 7,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'procurement'], capital_types: ['procurement'], portfolio_lanes: ['commercial-public-benefit', 'goods'] },
  ...
  {
    sourceKey: 'opportunity-source:tenders-nt',
    sourceKind: 'grant_source_page',
    sourceName: 'NT Quotations and Tenders Online',
    targetUrl: 'https://tendersonline.nt.gov.au/',
    parserHint: 'procurement-opportunity-directory',
    owningAgentId: 'grantscope-discovery',
    discoverySource: 'tenders-nt-opportunities',
    cadenceHours: 12,
    priority: 9,
    changeDetection: 'html',
    metadata: { roles: ['official-directory', 'procurement'], capital_types: ['procurement'], portfolio_lanes: ['commercial-public-benefit', 'goods', 'northern-territory'] },
  },
];
