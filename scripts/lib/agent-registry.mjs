...
export const AGENTS = {
  ...
  'discover-foundation-programs': {
    command: ['node', '--env-file=.env', 'scripts/discover-foundation-programs.mjs', '--refresh-existing', '--rescan-days=14', '--limit=15', '--concurrency=2'],
  ...
  'reconcile-grant-semantics': {
    command: ['node', '--env-file=.env', 'scripts/reconcile-grant-semantics.mjs', '--apply', '--limit=150'],
    displayName: 'Reconcile Grant Semantics',
    category: 'analytics',
    defaultPriority: 3,
    timeoutMs: 600_000,
    dependencies: [],
  ...
  'reconcile-grant-source-identity': {
    command: ['node', '--env-file=.env', 'scripts/reconcile-grant-source-identity.mjs', '--apply', '--limit=100'],
    displayName: 'Reconcile Grant Source Identity',
    category: 'analytics',
    defaultPriority: 3,
    timeoutMs: 300_000,
    dependencies: ['grantscope-discovery'],
  },
  'check-grant-semantics-health': {
    command: ['node', '--env-file=.env', 'scripts/check-grant-semantics-health.mjs', '--max-status-null=0', '--max-application-status-null=0', '--max-open-past-deadline=0'],
    displayName: 'Check Grant Semantics Health',
    category: 'analytics',
    defaultPriority: 2,
    timeoutMs: 120_000,
    dependencies: ['reconcile-grant-semantics'],
  },
  'check-grant-source-identity-health': {
    command: ['node', '--env-file=.env', 'scripts/check-grant-source-identity-health.mjs', '--max-blank-source-id=0', '--max-canonical-mismatch=0'],
    displayName: 'Check Grant Source Identity Health',
    category: 'analytics',
    defaultPriority: 2,
    timeoutMs: 120_000,
    dependencies: ['reconcile-grant-source-identity'],
  },
