...
async function main() {
  ...
  // Failure mode 3, found 2026-08-09 after 9 straight failed runs: the batch's
  // (source, name) is NEW but its url is already held by a DIFFERENT stored row
  // (GrantConnect retitles an opportunity, url survives, name changes). The
